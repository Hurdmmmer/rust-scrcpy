use crate::decoder::ffmpeg_decoder::{BgraFrame, FfmpegDecoder, FfmpegDecoderMode};
use crate::decoder::gpu_direct_output::{D3D11Context, D3D11TextureUploader};
        ...
        let uploader = match output_mode {
            DecoderOutputMode::GpuShared => {
                let ctx = D3D11Context::new().map_err(|e| {
                    crate::error::ScrcpyError::Decode(format!(
